sampler <- function(reef_df, sector_boundaries, num_samples, is_time_based,
  ...
  for (row in seq_along(unique_mgmts)) {
  ...
  sample_reefs_df <- dist_finder(
    sample_reefs_df, is_time_based, recov_th,
